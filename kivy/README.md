## About this project
This app creates whiteboard drawing style animation video just from an image.

## Resoultion Details (Reference)
| Resolution Name | Known As | Ratio | Width x Height (px) |
|:----------------|:---------|:------|:--------------------|
