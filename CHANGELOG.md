...
### 0.6.0
- Option to download old sketch animation file(s). [all]
...
- Using android native video player as `ffpyplayer` build is failing with latest p4a. [android]
- Added a `wakelock` while generating the sketch. [android]
